...
import (
	capApp "Wavelet/OpenFlare/plugins/server/cap"
...
func RegisterUserRoutes(apiV1Router core.RouterExtension, apiGroup core.RouterExtension) {
	// 1. CAPTCHA
...
func registerCaptchaRoutes(apiGroup core.RouterExtension) {
...
func registerConfigRoutes(apiV1Router core.RouterExtension) {
...
func registerOAuthRoutes(apiV1Router core.RouterExtension) {
...
func registerUserRoutes(apiV1Router core.RouterExtension) {
...
func registerUploadRoutes(apiV1Router core.RouterExtension) {
